...
fn input_block_add_dl(b: &mut [u32; 16], data_a: &[u32], data_b: &[u32]) {
	unsafe {
		*b.get_unchecked_mut(0) = b.get_unchecked_mut(0).wrapping_add(*data_a.get_unchecked(0));
		*b.get_unchecked_mut(1) = b.get_unchecked_mut(1).wrapping_add(*data_a.get_unchecked(1));
		*b.get_unchecked_mut(2) = b.get_unchecked_mut(2).wrapping_add(*data_a.get_unchecked(2));
		*b.get_unchecked_mut(3) = b.get_unchecked_mut(3).wrapping_add(*data_a.get_unchecked(3));
		*b.get_unchecked_mut(4) = b.get_unchecked_mut(4).wrapping_add(*data_a.get_unchecked(4));
		*b.get_unchecked_mut(5) = b.get_unchecked_mut(5).wrapping_add(*data_a.get_unchecked(5));
		*b.get_unchecked_mut(6) = b.get_unchecked_mut(6).wrapping_add(*data_a.get_unchecked(6));
		*b.get_unchecked_mut(7) = b.get_unchecked_mut(7).wrapping_add(*data_a.get_unchecked(7));
		*b.get_unchecked_mut(8) = b.get_unchecked_mut(8).wrapping_add(*data_b.get_unchecked(0));
		*b.get_unchecked_mut(9) = b.get_unchecked_mut(9).wrapping_add(*data_b.get_unchecked(1));
		*b.get_unchecked_mut(10) = b.get_unchecked_mut(10).wrapping_add(*data_b.get_unchecked(2));
		*b.get_unchecked_mut(11) = b.get_unchecked_mut(11).wrapping_add(*data_b.get_unchecked(3));
		*b.get_unchecked_mut(12) = b.get_unchecked_mut(12).wrapping_add(*data_b.get_unchecked(4));
		*b.get_unchecked_mut(13) = b.get_unchecked_mut(13).wrapping_add(*data_b.get_unchecked(5));
		*b.get_unchecked_mut(14) = b.get_unchecked_mut(14).wrapping_add(*data_b.get_unchecked(6));
		*b.get_unchecked_mut(15) = b.get_unchecked_mut(15).wrapping_add(*data_b.get_unchecked(7));
	}
}
...
fn input_block_sub_dl(b: &mut [u32; 16], data_a: &[u32], data_b: &[u32]) {
	unsafe {
		*b.get_unchecked_mut(0) = b.get_unchecked_mut(0).wrapping_sub(*data_a.get_unchecked(0));
		*b.get_unchecked_mut(1) = b.get_unchecked_mut(1).wrapping_sub(*data_a.get_unchecked(1));
		*b.get_unchecked_mut(2) = b.get_unchecked_mut(2).wrapping_sub(*data_a.get_unchecked(2));
		*b.get_unchecked_mut(3) = b.get_unchecked_mut(3).wrapping_sub(*data_a.get_unchecked(3));
		*b.get_unchecked_mut(4) = b.get_unchecked_mut(4).wrapping_sub(*data_a.get_unchecked(4));
		*b.get_unchecked_mut(5) = b.get_unchecked_mut(5).wrapping_sub(*data_a.get_unchecked(5));
		*b.get_unchecked_mut(6) = b.get_unchecked_mut(6).wrapping_sub(*data_a.get_unchecked(6));
		*b.get_unchecked_mut(7) = b.get_unchecked_mut(7).wrapping_sub(*data_a.get_unchecked(7));
		*b.get_unchecked_mut(8) = b.get_unchecked_mut(8).wrapping_sub(*data_b.get_unchecked(0));
		*b.get_unchecked_mut(9) = b.get_unchecked_mut(9).wrapping_sub(*data_b.get_unchecked(1));
		*b.get_unchecked_mut(10) = b.get_unchecked_mut(10).wrapping_sub(*data_b.get_unchecked(2));
		*b.get_unchecked_mut(11) = b.get_unchecked_mut(11).wrapping_sub(*data_b.get_unchecked(3));
		*b.get_unchecked_mut(12) = b.get_unchecked_mut(12).wrapping_sub(*data_b.get_unchecked(4));
		*b.get_unchecked_mut(13) = b.get_unchecked_mut(13).wrapping_sub(*data_b.get_unchecked(5));
		*b.get_unchecked_mut(14) = b.get_unchecked_mut(14).wrapping_sub(*data_b.get_unchecked(6));
		*b.get_unchecked_mut(15) = b.get_unchecked_mut(15).wrapping_sub(*data_b.get_unchecked(7));
	}
}
...
fn apply_p(a: &mut [u32; 12], b: &mut [u32; 16], c: &[u32; 16], data: &[u32]) {
	...
	perm(a, b, c, data);
	a[0] = a[0].wrapping_add(c[11]).wrapping_add(c[15]).wrapping_add(c[3]);
	a[1] = a[1].wrapping_add(c[12]).wrapping_add(c[0]).wrapping_add(c[4]);
	a[2] = a[2].wrapping_add(c[13]).wrapping_add(c[1]).wrapping_add(c[5]);
	a[3] = a[3].wrapping_add(c[14]).wrapping_add(c[2]).wrapping_add(c[6]);
	a[4] = a[4].wrapping_add(c[15]).wrapping_add(c[3]).wrapping_add(c[7]);
	a[5] = a[5].wrapping_add(c[0]).wrapping_add(c[4]).wrapping_add(c[8]);
	a[6] = a[6].wrapping_add(c[1]).wrapping_add(c[5]).wrapping_add(c[9]);
	a[7] = a[7].wrapping_add(c[2]).wrapping_add(c[6]).wrapping_add(c[10]);
	a[8] = a[8].wrapping_add(c[3]).wrapping_add(c[7]).wrapping_add(c[11]);
	a[9] = a[9].wrapping_add(c[4]).wrapping_add(c[8]).wrapping_add(c[12]);
	a[10] = a[10].wrapping_add(c[5]).wrapping_add(c[9]).wrapping_add(c[13]);
	a[11] = a[11].wrapping_add(c[6]).wrapping_add(c[10]).wrapping_add(c[14]);
}
