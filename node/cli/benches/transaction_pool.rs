...
use kumandra_cli::service::{create_extrinsic, fetch_nonce, FullClient, TransactionPool};
use kumandra_primitives::AccountId;
use kumandra_runtime::{constants::currency::*, BalancesCall, SudoCall};
...
fn new_node(tokio_handle: Handle) -> kumandra_cli::service::NewFullBase {
	...
	kumandra_cli::service::new_full_base(config, false, |_, _| ()).expect("Creates node")
}
