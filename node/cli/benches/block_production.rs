...
use kumandra_cli::service::{create_extrinsic, FullClient};
use kumandra_runtime::{constants::currency::*, BalancesCall};
...
fn new_node(tokio_handle: Handle) -> kumandra_cli::service::NewFullBase {
	...
	let spec = Box::new(kumandra_cli::chain_spec::development_config());
	...
	kumandra_cli::service::new_full_base(config, false, |_, _| ())
...
fn extrinsic_set_time(now: u64) -> OpaqueExtrinsic {
	kumandra_runtime::UncheckedExtrinsic {
		signature: None,
		function: kumandra_runtime::RuntimeCall::Timestamp(pallet_timestamp::Call::set { now }),
	}
	.into()
}
...
fn import_block(
	...
	built: BuiltBlock<
		...
		<FullClient as sp_api::CallApiAt<kumandra_primitives::Block>>::StateBackend,
	>,
) {
