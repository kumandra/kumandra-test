...
pub struct BlockContentIterator<'a> {
	...
	genesis_hash: kumandra_primitives::Hash,
				...
				function: match self.content.block_type {
					BlockType::RandomTransfersKeepAlive =>
						RuntimeCall::Balances(BalancesCall::transfer_keep_alive {
							...
							value: kumandra_runtime::ExistentialDeposit::get() + 1,
						}),
					BlockType::RandomTransfersReaping => {
						RuntimeCall::Balances(BalancesCall::transfer {
							...
							value: 100 * DOLLARS -
								(kumandra_runtime::ExistentialDeposit::get() - 1),
						})
					},
					BlockType::Noop =>
...
impl BenchKeyring {
	...
	pub fn generate_genesis(&self) -> kumandra_runtime::GenesisConfig {
		crate::genesis::config_endowed(
			Some(kumandra_runtime::wasm_binary_unwrap()),
