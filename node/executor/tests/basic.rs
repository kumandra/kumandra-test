...
use kumandra_primitives::{Balance, Hash};
...
pub fn bloaty_code_unwrap() -> &'static [u8] {
	kumandra_runtime::WASM_BINARY_BLOATY.expect(
...
fn should_import_block_with_test_client() {
	...
	let block = kumandra_primitives::Block::decode(&mut &block_data[..]).unwrap();
